...
const styles = StyleSheet.create({
  ...
  power: { backgroundColor: "#35443D", height: 42, width: 42, borderRadius: 18, alignItems: "center", justifyContent: "center" },
  ...
  notice: { flexDirection: "row", alignItems: "center", gap: 10, backgroundColor: C.warning, padding: 14, borderRadius: 18, minHeight: 48 },
